      ...
      <DetailsGrid>
        ...
        <ServiceDetailsSection>
          ...
          <DetailItem>
            ...
            <Value>{specificService.name}</Value>
          </DetailItem>
          <DetailItem>
            <Label>Father/Husband Name</Label>
            <Value>{specificService.fatherHusbandName}</Value>
          </DetailItem>
        </ServiceDetailsSection>
        ...
        <ServiceDetailsSection>
          ...
          <DocumentItem>
            <DocumentLabel>Passbook</DocumentLabel>
            <DocumentPreviewWrapper>
              {specificService.passbookFilePath &&
              specificService.passbookFilePath.endsWith(".pdf") ? (
                <PDFPlaceholder>
                  <BookOpen size={40} />
                  <span>Passbook PDF Document</span>
                </PDFPlaceholder>
              ) : (
                <DocumentPreview
                  src={`${import.meta.env.VITE_API_BASE_URL}${
            ...
            <DocumentGrid>
              {service.documents.map((doc, index) => (
                <DocumentItem key={index}>
                  ...
                  {doc.filePath && doc.filePath.endsWith(".pdf") ? (
                    <PDFPlaceholder>
                      <FileText size={40} />
                  ...
                  <DownloadButton
                    onClick={() =>
                      downloadDocument(
                        `${import.meta.env.VITE_API_BASE_URL}${doc.filePath}`,
...
export default ServiceDetailsJobCard;
